...
function nextProfile() {
  ...
  if (currentProfile !== undefined) {
    ...
    document.getElementById(
      'imageDisplay'
    ).innerHTML = `<img src="${currentProfile.imgURL}">`;
  } else {
    // No More Profiles
